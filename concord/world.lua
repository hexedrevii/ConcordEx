...
---@class World
---@field __entities List<Entity>
---@field __systems List<System>
---@field __events table
---@field  __emitSDepth number
---@field  __resources table
---@field  __hash table
---@field  __added List<Entity>
---@field  __backAdded List<Entity>
---@field  __removed List<Entity>
---@field  __backRemoved List<Entity>
---@field  __dirty List<Entity>
---@field  __backDirty List<Entity>
---@field  __systemLookup table
---@field  __isWorld boolean
---@field  __ignoreEmits boolean
---@field afterEmit function
---@field beforeEmit function
...
--- Creates a new World.
---@return World world The new World
function World.new()
    ---@type World
...
---@return Entity e the new Entity
function World:newEntity()
    return Entity(self)
end

--- Queries the World for Entities matching a filter.
---@param def table The filter definition
---@param onMatch? function|table Callback function, or table to append results to
---@return table? list The list of entities if `onMatch` is a table or nil
...
---@param e Entity Entity to mark as dirty
...
---@see World:emit
---@param systemClass SystemClass SystemClass of System to add
---@return World self
...
---@see World:addSystem
---@see World:emit
---@param ... SystemClass SystemClasses of Systems to add
---@return World self
...
---@param systemClass SystemClass SystemClass of System to check for
---@return boolean
...
---@param systemClass SystemClass SystemClass of System to get
---@return System system System to get
...
--- Gets the active entities in the world.
---@return List
function World:getEntities()
    return self.__entities
end

--- Gets the active systems in the world.
---@return List
function World:getSystems()
    return self.__systems
end

--- Serializes the world data.
---@param ignoreKeys? boolean Whether to ignore component keys during serialization
---@return table data Serialized world data
...
--- Deserializes world data.
---@param data table The serialized world data
---@param startClean? boolean Clear the world before applying data
---@param ignoreGenerator? boolean Do not override the current key generator state
---@return World self
...
--- Sets the generator function for entity keys.
---@param generator function The generator function
---@param initialState any The initial state for the generator
---@return World self
...
--- Internal: Clears a key assigned to an entity.
...
--- Internal: Assigns a key to an entity.
---@param e Entity The entity
---@param key? any Optional explicit key to assign
---@return any key The assigned key
...
--- Gets an Entity by its assigned key.
---@param key any The key
---@return Entity? entity The entity, or nil if not found
